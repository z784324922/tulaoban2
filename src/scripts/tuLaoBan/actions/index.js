...
//改变pageheader
export function change_pageheader(thisUrl){
    var aUrl = thisUrl.split("/");
    var newUrl = [];
    ...
    // console.log(aUrl);
    // console.log(newUrl);
    return store.dispatch({type:"to_change_pageheader",newUrl})
}

//改变每页条数
export function change_pagesize(pageSize){
    return store.dispatch({type:"to_change_pageSize",pageSize})
}